...
import com.example.newstab.databinding.FragmentSearchBinding
...
import com.example.newstab.utils.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.searchEdit.addTextChangedListener { editable ->
            ...
            job = MainScope().launch {
                delay(SEARCH_NEWS_TIME_DELAY.toLong())
                editable?.let {
                ...
                when (response) {
                    ...
                    is Resource.Error<*> -> {
                        ...
                        response.message?.let { message ->
                            Toast.makeText(
                                activity, "Desculpa manin: $message",
                                Toast.LENGTH_SHORT
                            ).show()
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (shouldPaginate) {
                newsViewModel.getHeadLines(binding.searchEdit.text.toString())
                isScrolling = false
            }
        }
